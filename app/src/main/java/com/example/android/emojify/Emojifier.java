...
public class Emojifier {
    ...
    public static Bitmap detectFacesAndOverlayEmoji(Context context, Bitmap bitmap) {
        ...
        Log.i(TAG, "Faces : " + faces.size());
        if (faces.size() == 0) {
            Toast.makeText(context, "No faces detected" + faces.size(), Toast.LENGTH_LONG).show();
        } else {
            for (int i = 0; i < faces.size(); i++) {
                ...
                Toast.makeText(context, "Faces detected", Toast.LENGTH_LONG).show();
